...
const hiddenElements = document.querySelectorAll('.hidden_for_animation, .right, .the-middle-section, .animation_from_right, .animation_from_bottom, .animation_for_footer, .from_right, .fade_in_animation');
